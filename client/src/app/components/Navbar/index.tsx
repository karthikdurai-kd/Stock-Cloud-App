...
const NavBar = () => {
  // Getting toggle and dark mode state from redux store
  ...
  // Triggering redux action "setIsSidebarCollapsed"
  const toggleSidebar = () => {
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <Image
              src="https://s3-stockcloud.s3.amazonaws.com/profilePic.png"
              alt="Profile"
              width={50}
              height={50}
